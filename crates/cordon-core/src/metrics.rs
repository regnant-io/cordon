...
use prometheus::{
    ...
    HistogramOpts, IntCounter, IntGauge, Registry,
};
...
impl CordonMetrics {
    ...
    pub fn new() -> Result<Self, prometheus::Error> {
        ...
        Ok(Self {
            ...
            uptime_seconds: gauge!("cordon_uptime_seconds", "Node uptime in seconds"),
...
// `Default` is deliberately not implemented. Constructing the metric registry
// can fail — a duplicate collector registration, for one — and a `Default` that
// panics turns a recoverable startup error into an abort. Call
// [`CordonMetrics::new`] and handle the error.
